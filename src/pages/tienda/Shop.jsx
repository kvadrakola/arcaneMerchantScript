  ...
  return (
    <PageShell>
      <section className="shop-hall flex min-h-[calc(100vh-74px)] flex-col">
        ...
        <div className="flex-1 px-4 pt-6 pb-10 sm:px-6 lg:pr-10 lg:pl-[64px]">
          <h1 className="sr-only">Tienda del reino</h1>

          <div className="grid grid-cols-1 gap-7 lg:grid-cols-[340px_minmax(0,1fr)]">
            <CatalogueSidebar
...
function CatalogueSidebar({
  ...
  return (
    <div className="shop-sidebar flex flex-col">
      <aside className="shop-panel relative h-fit px-8 py-9">
